...
function AnalysePageContent() {
  ...
  return (
    <div className="min-h-screen bg-cursor-bg-primary flex">
      ...
      <aside className="w-80 bg-gradient-to-b from-cursor-bg-elevated via-cursor-bg-tertiary to-cursor-bg-secondary border-r border-white/[0.08] fixed left-0 top-14 h-[calc(100vh-3.5rem)] overflow-y-auto">
        <div className="p-6">
