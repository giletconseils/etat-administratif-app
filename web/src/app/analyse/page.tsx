            ...
            <div className={`p-4 ${currentStep === 3 ? 'bg-cursor-bg-secondary rounded-xl' : 'animated-border-content'}`}>
              ...
              >
                ...
                <div className="space-y-3">
                  {/* Bouton nouvelle analyse si étape 3 */}
                  {currentStep === 3 && (
                    <button
                      onClick={resetProcess}
                      className="w-full text-white bg-blue-600 hover:bg-blue-700 font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-2 text-xs"
                    >
