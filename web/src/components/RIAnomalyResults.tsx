...
export function RIAnomalyResults({ results, thresholds = DEFAULT_RI_THRESHOLDS }: RIAnomalyResultsProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Check if we've scrolled past the summary section (roughly 400px)
  ...
  return (
    <div className="card-surface p-6 mb-6 group/results">
      ...
      <div className="sticky-header -mx-6 mb-6 transition-all duration-500 ease-out group-hover/results:mx-[-10%]">
        <div className={`
