      ...
      <div className="mb-6 relative">
        <div className="flex items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-md shadow-orange-500/10">
        ...
        <div className="card-surface p-4 rounded-xl border border-[#2a2a2a] shadow-md">
          <div className="flex items-center justify-between">
            ...
            {filtered.length > 0 && (
              <button
                onClick={onExport}
                className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 rounded-lg transition-all shadow-sm hover:shadow-md flex items-center gap-2"
              >
